export const squadMembers: Array<{ name: string; imageLarge: string; portrait:string;}> = [
    {
        name: "Highwayman",
    ...
    },
    {
        ...
        portrait: "https://static.wikia.nocookie.net/darkestdungeon_gamepedia/images/d/d4/Bounty_hunter_portrait_roster.png/revision/latest?cb=20150717051741",
    },
];